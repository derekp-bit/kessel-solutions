...
export const Header = () => {
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl px-6 md:px-12 lg:px-20 py-6 flex items-center justify-between">
        <Link 
          to="/" 
          className="cursor-pointer"
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
        >
          <img src={logo} alt="Kessel Solutions" className="h-20 md:h-24 lg:h-28 hover:opacity-70 transition-opacity invert" />
        </Link>
